All the plugins that are currently supported by OctoDash are listed here. Want to have an additional plugin supported? Please open a Pull Request with the implementation and some screenshots. Thanks!
